...
export default function Detail() {
    ...
    const message = `Olá ${incident.name}, estou entrando em contato porque 
    quero a ajudar no caso "${incident.title}" com valor R$ ${Intl.NumberFormat('pt-BR', { 
        style: 'currency', 
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.incident}>
                    ...
                    <Text style={styles.incidentValue}>{incident.name} do {incident.uf}</Text>
